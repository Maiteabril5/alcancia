...
public class InterfazAlcancia extends JFrame {
        ...
        if (alcancia.darEstado().equals("NO ROTA")) {
            switch (pDenominacion) {
                ...
                case 500:
                    ...
                    break;
                default:
                    JOptionPane.showMessageDialog(this, "Denominación de moneda no válida.", "Agregar moneda", JOptionPane.ERROR_MESSAGE);
                    return;
            }
    ...
    public void reqFunc2() {
        String resultado = alcancia.valiosa()
                ...
                : "La alcancía no es valiosa, posee monedas de denominaciones diferentes a 1000 o de 500";
        JOptionPane.showMessageDialog(this,
                resultado,
                "Respuesta",
                JOptionPane.INFORMATION_MESSAGE);
